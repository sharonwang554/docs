...
- [ ] **Word doc ready**: Have the CATME/TMS Word document ready for anonymization
...
└── src/
    ...
    │       ├── tms/                         # Anonymized CATME docs (5 pages)
...
| **Legacy system onboarding** | TMS docs (getting-started guide for a complex Perl system) |
...
| **Troubleshooting & support** | TMS troubleshooting guide (runbook-style diagnostics) |
...
### Section 2: TMS (Anonymized CATME Docs)
    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            { label: 'Overview', slug: 'tms/overview' },
            { label: 'Getting Started', slug: 'tms/getting-started' },
            { label: 'Architecture', slug: 'tms/architecture' },
            { label: 'Developer Tips', slug: 'tms/developer-tips' },
            { label: 'Troubleshooting', slug: 'tms/troubleshooting' },
          ],
        },
        {
...
- [ ] TMS section contains no identifying information (university, product name, personnel)
