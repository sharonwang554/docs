...
| **TeamAssign Platform** | `*.teamassign.org` *(Anonymized Legacy Platform)* | Perl 5, mod_perl2, Apache, Template Toolkit, PostgreSQL | [`/teamassign`](https://docs.sharonwang.me/teamassign/overview) |
...
│   ├── teamassign/             # Anonymized institutional knowledge capture and onboarding guide for a 15-year-old Perl/mod_perl platform
